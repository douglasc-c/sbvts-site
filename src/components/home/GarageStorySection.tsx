    ...
    <section className="home-garage-band" style={{ backgroundImage: `url(${imageUrl})` }}>
      <article className="home-garage-panel">
        ...
        <p>
          ...
          Não existe espaço para individualismo quando se usa o bombril. A padronização mantém a ordem, fortalece a hierarquia e garante que todos caminhem na mesma direção.
